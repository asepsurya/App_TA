          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Data Tabel Tera Ulang</h1>
					<div class="row">
						<div class="col-12">
							<div class="card">
					...
					<div class='col-12 col-md-6'>
						<div class="card">
							...
							<div class="card-body">
							<form id='formtable' action="../asset/aksi_tabel_tera/proses_input_table.php" method="post">
						...
						<div class="card">
							<div class="card-body">
                                        ...
                                        <input type="text" name="jenisuttp" id="jenisuttp" class="form-control"required>        
                                    </div>
                                   		<div class="form-group mb-3">
                                        <label for="kekuatan" class=" form-control-label">Kekuatan</label>
                                        <input type="text" name="kekuatan" id="kekuatan" class="form-control"required value="50"> 
									</div>
                                    	<div class="form-group mb-3">
                                        <label for="noseri" class=" form-control-label">No Seri</label>
                                        <input type="number" onkeypress="return hanyaAngka(event)" name="noseri" id="noseri" value="<?php echo $NoSeri ?>" class="form-control"required>
                                    </div>
                                    	<div class="form-group mb-3">
                                        <label for="jumlah" class=" form-control-label">Hasil Pengecekan</label>
                                        <input type="number" name="jumlah" id="jumlah" onkeypress="return hanyaAngka(event)" value="<?php echo $Jumlah ?>"class="form-control"required>
                                    </div>
							</div>
							<div class="card-body">
