          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Form Input Data Petugas</h1>
					<div class="row">
						<div class="col-12">
							<div class="card">
					...
					<div class='col-12 col-md-6'>
						<div class="card">
							...
							<div class="card-body">
							<form id='formtable' action="../asset/aksi_tabel_tera/proses_input_anggota.php" method="post">
							<?php
                  
		
				 
				// mengambil ID_anggota dengan kode paling besar
				 $koneksi = mysqli_connect('localhost','root','','dbtera');
				 $query = mysqli_query($koneksi, "SELECT max(kode_petugas) as kodeTerbesar FROM tbl_petugas");
				 $data1 = mysqli_fetch_array($query);
				 $kodemember = $data1['kodeTerbesar'];              
				...
				// bilangan yang diambil ini ditambah 1 untuk menentukan nomor urut berikutnya
				 ...
				 ?>
									<div class="form-group mb-3">
										...
										<input type="text" name="id_petugas" id="tanggal" class="form-control" value="<?php echo $kodemember ?>" ReadOnly>
										<small>* kode Petugas diisi Otomatis</small>
									</div>
									<div class="form-group mb-3">
                                        <label for="petugas mb-3" class=" form-control-label">Nama Petugas</label>
                                    	<input type="text" name="nm_petugas" id="petugas" class="form-control"required>
                                    </div>
						...
						<div class="card">
							<div class="card-body">
                                        ...
                                        <input type="text" name="no_kontak" id="jenisuttp" class="form-control" value="(+62)">        
                                    </div>
                                   		<div class="form-group mb-3">
                                        <label for="kekuatan" class=" form-control-label">Jabatan</label>
                                        <input type="text" name="jabatan" id="kekuatan" class="form-control"required > 
									</div>
                            ...
                            <button type="submit" name="input" class="btn btn-primary">+ Tambah Data</button>
							</div>
