...
<body>
	<div class="wrapper">
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Data Tabel Pemeriksaan</h1>
					<div class="row">
						<div class="col-12">
							<div class="card">
                    ...
                    $aa=date('Y-m-d');
                    $b=date('Y-m-d',strtotime('+6 month',strtotime($aa)));
	
      $query = "SELECT * FROM tbl_pemeriksaan";
      ...
      // mencetak / menampilkan data
        ...
        echo "<td><i class='align-middle me-1' data-feather='calendar'></i> $data[tgl_pengecekan_awal]</td>";
        echo "<td><i class='align-middle me-1' data-feather='clock'></i> $b</td>";
        echo "<td>$data[nama_pemilik]</td>"; //menampilkan no urut
        echo "<td>$data[nm_pemeriksa]</td>"; //menampilkan no urut
       // echo "<td>".$diff->d."hari</td>";
        $tgl_now=date("d-m-Y");
		$tgl_exp=$data['tgl_pengecekan_akhir'];//tanggal expired
		if ($tgl_now >$tgl_exp ){
			
         	echo'<td><a href="" class="btn btn-danger"> Belum di Cek</a></td>';
		}else{
