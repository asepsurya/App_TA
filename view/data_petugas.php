	...
	<div class="wrapper">
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
        		...
        		<a href="input_anggota.php"><button type="submit" class="btn btn-primary">+ Tambah Data</button></a>
      ...
      // mencetak / menampilkan data
		...
		echo "<td>$data[tanggal_input]</td>"; //menampilkan data jenisuttp
		...
		echo "<td>$data[jabatan]</td>"; //menampilkan data noseri
       echo '<td class="d-none d-xl-table-cell ">
		  <div class="btn-group btn-group-sm mb-3" role="group" aria-label="Small button group">
		  <a href="edit_anggota.php?id='.$data['kode_petugas'].'" class="btn btn-primary">Edit</a>
		  <a href="../asset/aksi_tabel_tera/hapus_anggota.php?id='.$data['kode_petugas'].'" class="btn btn-danger"> <i class="align-middle me-1" data-feather="trash-2"></i></a>
